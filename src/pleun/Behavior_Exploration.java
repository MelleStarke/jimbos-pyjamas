...
class Behavior_Exploration implements Behavior {
	private boolean suppressed;
	private ColorSensor csLeft;
	private ColorSensor csRight;
	private static final int SPEED = 250;
	
	public Behavior_Exploration(ColorSensor csLeft, ColorSensor csRight)
  {
	suppressed = false;
    this.csLeft = csLeft;
	...
	public void action() {
		if ( !suppressed ) {
			...
			Motor.A.setSpeed( SPEED - csLeftSample * 1000 );
			Motor.D.setSpeed( SPEED - csRightSample * 1000 );
